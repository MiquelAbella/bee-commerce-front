    ...
    <div className="mt-24">
      ...
      <div className="flex flex-col p-8">
        ...
        <div className="grid grid-cols-1 gap-4 place-items-center md:grid-cols-3 p-8">
          <a
            href="https://www.europcar.com/en/car-rental/locations/germany"
            target="_blank"
          ...
          >
            ...
            />
            <Typography text={`Rent a car in Berlin`} />
          </a>
          <a
            href="https://www.civitatis.com/en/germany"
            target="_blank"
            className="flex flex-col items-center justify-center"
          >
            <img
            ...
            />
            <Typography text={`Find activities in Berlin`} />
          </a>
          <a
            href="https://es.foursquare.com/explore?mode=url&near=Berlin%"
            target="_blank"
            className="flex flex-col items-center justify-center"
          >
            <img
            ...
            />
            <Typography text={`Find restaurants in Berlin`} />
          </a>
        </div>
      </div>
      <div>
